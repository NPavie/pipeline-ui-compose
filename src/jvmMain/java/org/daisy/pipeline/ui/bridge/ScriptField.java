...
public class ScriptField {
	...
	public static ScriptField mockPort(String name,
									   String niceName,
									   String description,
									   boolean isSequence,
									   String mediaType,
	...
	public static ScriptField mockOption(String name,
										 String niceName,
										 String description,
										 boolean isSequence,
										 String mediaType,
										 ...
										 boolean isRequired,
										 boolean isOrdered,
										 XProcOptionMetadata.Output output,
										 String defaultValue
	){
		return new ScriptField(
				name,
				...
				isOrdered,
				dataType,
				defaultValue != null && defaultValue.isEmpty() == false ?
