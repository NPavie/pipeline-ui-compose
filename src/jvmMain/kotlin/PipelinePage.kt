...
@Composable
@Preview
fun PipelinePage(pageFocusRequester: FocusRequester){

    Column (
        Modifier.semantics {
            this.text = AnnotatedString("Pipeline panel")
        }
    ) {
        Text("Pipeline page to be designed", Modifier.focusable().focusRequester(pageFocusRequester))
    }
